...
<div id="wrap">
	<div class="wpsisac-sf-wrap">
		<div class="wpsisac-sf-inr">
			...
			<div class="wpsisac-sf-features-section wpsisac-sf-team wpsisac-sf-center">
					<h1 class="wpsisac-sf-heading">Powerful Team Behind <span class="wpsisac-sf-blue">Slick Slider</span></h1>
						...
						<p></p>
						<div class="wpsisac-sf-cont">This is why I wanted to introduce you to <span class="wpsisac-sf-blue">Anoop Ranawat & Team</span> at EssentialPlugin.com</div>
			...
			<div class="wpsisac-sf-welcome-wrap">
				<div class="wpsisac-sf-welcome-inr wpsisac-sf-center">					
						...
						<a href="<?php echo esc_url( $wpsisac_add_link ); ?>" class="wpsisac-sf-btn">Launch Slick Slider With Free Features</a> <br /><b>OR</b> <br /> <a href="<?php echo WPSISAC_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wpsisac-sf-btn wpsisac-sf-btn-orange"> <span class="dashicons dashicons-cart"></span> Grab Now With Essential Bundle</a>
			...
			<div class="wpsisac-features-section">
				...
				<div class="wpsisac-sf-welcome-wrap wpsisac-sf-center">	
					...
					<a href="<?php echo WPSISAC_PLUGIN_BUNDLE_LINK; ?>" target="_blank" class="wpsisac-sf-btn wpsisac-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Grab Now Pro Features</a>
					<div class="wpsisac-rc-wrap">
						<div class="wpsisac-rc-inr wpsisac-rc-bg-box">
							<div class="wpsisac-rc-icon">
								<img src="<?php echo esc_url( WPSISAC_URL ); ?>assets/images/popup-icon/14-days-money-back-guarantee.png" alt="14-days-money-back-guarantee" title="14-days-money-back-guarantee" />
			...
			<div class="wpsisac-sf-testimonial-wrap">
				<div class="wpsisac-sf-center wpsisac-sf-features-ttl">
					<h1 class="wpsisac-sf-heading">Looking for a Reason to Use <span class="wpsisac-sf-blue">Slick Slider</span>?</h1>	
				...
				<div class="wpsisac-testimonial-section-inr">
					...
					<a href="https://wordpress.org/support/plugin/wp-slick-slider-and-image-carousel/reviews/?filter=5" target="_blank" class="wpsisac-sf-btn"><span class="dashicons dashicons-star-filled"></span> View All Reviews</a> OR <a href="<?php echo WPSISAC_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wpsisac-sf-btn wpsisac-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Grab Now Pro Features</a>
					<div class="wpsisac-rc-wrap">
						<div class="wpsisac-rc-inr wpsisac-rc-bg-box">
							<div class="wpsisac-rc-icon">
								<img src="<?php echo esc_url( WPSISAC_URL ); ?>assets/images/popup-icon/14-days-money-back-guarantee.png" alt="14-days-money-back-guarantee" title="14-days-money-back-guarantee" />
