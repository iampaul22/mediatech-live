					...
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							<ul class="wpos-list">
								...
								<li><?php esc_html_e( 'Elementor, Bevear and SiteOrigin Page Builder Support. <span class="wpos-new-feature">New</span>', 'wp-slick-slider-and-image-carousel'); ?></li>
								<li><?php esc_html_e( 'Divi Page Builder Native Support.<span class="wpos-new-feature">New</span>', 'wp-slick-slider-and-image-carousel'); ?></li>
								<li><?php esc_html_e( 'Fusion Page Builder (Avada) native support.<span class="wpos-new-feature">New</span>', 'wp-slick-slider-and-image-carousel'); ?></li>
