			...
			<div id="item-header-content">
				...
				<div class="flex">
					<div class="bb-user-content-wrap">
						...
						<div class="cust-register-here-section">
							<div>
								<?php if(!is_user_logged_in()) { ?> 
									<a href="https://mediatech.ventures/join" class="button small singup">Register Here</a>
								<?php }?> 
							</div>

							<div><?php bp_nouveau_member_hook( 'before', 'header_meta' ); ?></div>
						</div>
