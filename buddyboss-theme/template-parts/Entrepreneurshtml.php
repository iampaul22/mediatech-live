<?php
/* Template Name: Entrepreneurs-html */
get_header();
?>
...
@media all and (max-width : 1024px){
	...
	<section class="Evolving_media_section" style="background-image: url(https://mtvstaging.wpengine.com/wp-content/uploads/2020/10/home-banner.jpg);">
		<div class="container">
			<div class="inner">
				...
				<p><?php echo the_field('hero_sub_title'); ?></p>
				<a href="<?php echo the_field('hero_button_url');?>">
				<button onclick><?php echo the_field('hero_button_text'); ?></button>	
				</a>
			</div>
		</div>
	</section>
	...
	<div class="start_now_container">	
		<div class="container">			
			<div class="inner">
				<h2><?php the_field ('start_now_title'); ?></h2>
				<p><?php echo the_field('start_now_content'); ?></p>
			...
			<div class="inner">
				<h3><?php echo the_field ('move_beyond_title') ;?><abbr><a href="<?php echo the_field('move_beyond_link');?>"> <?php echo the_field ('move_beyond_link_text') ;?></a>.</abbr></h3>

				<div class="avatar">
					<a href="/profile/seobrien/">
						<span class="et_pb_image_wrap ">
						<img src="<?php echo the_field('profile_image'); ?>" alt="" title="Paul" data-lazy-src="https://mtvstaging.wpengine.com/wp-content/uploads/2020/10/Paul.png" data-ll-status="loaded" class="entered lazyloaded">
						<noscript>
				...
				<div class="avatar_heading">
					<span>
						<img src="<?php echo the_field('profile_signature_image'); ?>" alt="Sign Paul" title="sig-paul" data-lazy-src="https://mtvstaging.wpengine.com/wp-content/uploads/2020/10/sig-paul.png" data-ll-status="loaded" class="entered lazyloaded">
						<noscript>
							<img src="https://mtvstaging.wpengine.com/wp-content/uploads/2020/10/sig-paul.png" alt="Sign Paul" title="sig-paul" />
						</noscript>
					</span>
				</div>
			</div>
	...
	<div class="move" style="background-image: url(https://mtvstaging.wpengine.com/wp-content/uploads/2020/10/Media-Evolved.jpg)">
		<div class="container">
			<div class="inner">
				<div class="text">
					<h4><?php echo the_field('learn_how_to_title'); ?></h4>
					<p><?php echo the_field('learn_how_to_sub_title'); ?></p>
					<a href="<?php echo the_field('learn_how_to_button_url');?>">
						<button class="btn"><?php echo the_field('learn_how_to_button_text'); ?></button>
					</a>
				</div>
			</div>
		</div>
	...
	<div class="evolutionaries" style="background-image:url(https://mtvstaging.wpengine.com/wp-content/uploads/2020/10/bg-inner.jpg); background-size: cover;">
		<div class="container">
			<div class="inner">
				<div class="text">
					...
					<p><?php the_field('evolutionaries_sub_title'); ?></p>
				</div>
			</div>
			<div class="inner">
				<div class="evolutionaries_box_wrapper">
					<?php
						// Check rows exists.
						if ( have_rows( 'evolutionaries_profile_section' ) ):
							while( have_rows( 'evolutionaries_profile_section' ) ) : the_row();
						?>
						<div class="box">
							<a href="<?php echo get_sub_field('profile_url'); ?>" target="blank" >
								<div class="image">
									<img src="<?php echo get_sub_field('profile_image'); ?>" alt="Toh Cohen">
								</div>
			...
			<div class="inner">
				<div class="evol-button">
					<a href="<?php echo the_field('evolutionaries_button_1_url'); ?>" target="blank" class="start-btn"><?php echo the_field('evolutionaries_button_1_text'); ?></a>
					<a href="<?php echo the_field('evolutionaries_button_2_url'); ?>" target="blank" class="directory-btn"><?php echo the_field('evolutionaries_button_2_text'); ?></a>
				</div>
			</div>
		</div>	
		...
		<div class="container-evol">
			<!--	<div class="box">
				<a href="#0">
					<div class="image">
						<img src="https://mtvstaging.wpengine.com/wp-content/uploads/2020/12/nakevia-miller.jpg" alt="Paul O'Brien">
					</div>
				
					<div class="evol-name">
						<h1>Nakevia Miller</h1>
					</div>
				</a>
			</div>
			...
			<div class="box">
				<a href="#0">
					<div class="image">
						<img src="https://mtvstaging.wpengine.com/wp-content/uploads/2020/10/christy-cardenas.jpg" alt="Christy Cardenas">
					</div>
				
					<div class="evol-name">
						<h1>Christy Cardenas</h1>
					</div>
				</a>
			</div>
			...
			<div class="box">
				<a href="#0">
					<div class="image">
						<img src="https://mtvstaging.wpengine.com/wp-content/uploads/2020/10/heath-butler.jpg" alt="Heath Butler">
					</div>
		...
		<div class="container">
			<div class="inner">				
				...
				<div class="read-content">
					<?php
				// Check rows exists.
				if ( have_rows( 'must_read_content' ) ):
				while( have_rows( 'must_read_content' ) ) : the_row();
				?>
					<div class="read-box">
						<div class="image">
							<?php 
								$image = get_sub_field('must_read_image');
								if( $image ){ ?>
						...
						<div class="read-text">
							<a href="<?php echo get_sub_field('must_read_url') ?> "><?php echo get_sub_field('must_read_title'); ?> </a>
						</div>
					</div>
					<?php  endwhile ;
