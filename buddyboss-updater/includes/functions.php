	...
	foreach ( $all_plugins as $plugin_file => $plugin_details ) {
		if ( 'buddyboss-media/buddyboss-media.php' == $plugin_file ) {
			$packages['bbmedia'] = array(
				...
				'path'     => $plugin_file,
				'package'  => 'plugin',
				'name'     => __( 'BuddyBoss Media', 'buddyboss-updater' ),
				'products' => array(
					'BBMEDIA' => array(
		...
		if ( 'buddyboss-wall/buddyboss-wall.php' == $plugin_file ) {
			$packages['bbwall'] = array(
				...
				'path'     => $plugin_file,
				'package'  => 'plugin',
				'name'     => __( 'BuddyBoss Wall', 'buddyboss-updater' ),
				'products' => array(
					'BBWALL' => array(
		...
		if ( 'buddypress-location-autocomplete/bp-location-autocomplete.php' == $plugin_file ) {
			$packages['bblacbp'] = array(
				...
				'path'     => $plugin_file,
				'package'  => 'plugin',
				'name'     => __( 'Location Autocomplete', 'buddyboss-updater' ),
				'products' => array(
					'BBLACBP' => array(
		...
		if ( 'boss-learndash/boss-learndash.php' == $plugin_file ) {
			$packages['slearner_ld'] = array(
				...
				'path'     => $plugin_file,
				'package'  => 'plugin',
				'name'     => __( 'Social Learner - Learndash', 'buddyboss-updater' ),
				'products' => array(
					'SLEARNER_BFLD' => array(
						'software_ids' => array(
							'SLEARNER_LD_UPGRADE',
						...
						'name'         => __( 'Boss for Learndash', 'buddyboss-updater' ),
					),
					'BOSS'          => array(
						'software_ids' => array( 'BOSS_1S', 'BOSS_5S', 'BOSS_20S' ),
						'name'         => __( 'Boss', 'buddyboss-updater' ),
					),
				),
			);
		...
		if ( 'buddyboss-marketplace/buddyboss-marketplace.php' == $plugin_file ) {
			$packages['socmp'] = array(
				...
				'path'     => $plugin_file,
				'package'  => 'plugin',
				'name'     => __( 'Social MarketPlace', 'buddyboss-updater' ),
				'products' => array(
					'SOCMP'     => array(
					...
					'ONESOCIAL' => array(
						...
						'name'         => __( 'OneSocial Theme', 'buddyboss-updater' ),
					)
				),
			);
		...
		if ( 'buddypress-member-type/buddyboss-bmt.php' == $plugin_file ) {
			$packages['bpmemtypes'] = array(
				...
				'path'     => $plugin_file,
				'package'  => 'plugin',
				'name'     => __( 'BuddyPress Member Types', 'buddyboss-updater' ),
				'products' => array(
					'BPMEMTYPES' => array(
		...
		if ( 'buddyboss-platform-pro/buddyboss-platform-pro.php' == $plugin_file ) {
			$packages['buddyboss_theme'] = array(
				...
				'package'  => 'theme',
				'name'     => __( 'BB Theme & Platform Pro', 'buddyboss-updater' ),
				'products' => array(
	...
	foreach ( $all_themes as $theme_directory => $theme_details ) {
		if ( 'boss' == $theme_directory ) {
			$packages['boss'] = array(
				...
				'package'  => 'theme',
				'name'     => __( 'Boss Theme', 'buddyboss-updater' ),
				'products' => array(
					'BOSS' => array(
						'software_ids' => array( 'BOSS_1S', 'BOSS_5S', 'BOSS_20S' ),
						'name'         => __( 'Boss Theme', 'buddyboss-updater' ),
	...
	foreach ( $all_plugins as $plugin_file => $plugin_details ) {
		...
		if ( 'buddypress-user-blog/bp-user-blog.php' == $plugin_file ) {
			$packages['bpublog'] = array(
				...
				'path' => $plugin_file,
				'package' => 'plugin',
				'name'     => __( 'BuddyPress User Blog', 'buddyboss-updater' ),
				'products' => array(
					'BPUBLOG' => array(
			...
			$packages['socblogger'] = array(
				...
				'path' => $plugin_file,
				'package' => 'plugin',
				'name'     => __( 'Social Blogger', 'buddyboss-updater' ),
				'products' => array(
					'BPUBLOG'   => array(
