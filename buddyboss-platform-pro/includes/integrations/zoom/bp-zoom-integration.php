...
class BP_Zoom_Integration extends BP_Integration {
	...
	public function enqueue_scripts_styles() {
		...
		$rtl_css = is_rtl() ? '-rtl' : '';
		wp_enqueue_style( 'bp-zoom-meeting-admin', bp_zoom_integration_url( '/assets/css/bp-zoom-meeting-admin' . $rtl_css . $min . '.css' ), false, bb_platform_pro()->version );
	}
	...
	public function register_meta_table() {
		...
		$wpdb->recordingmeta = bp_core_get_table_prefix() . 'bp_zoom_recording_meta';
	}
