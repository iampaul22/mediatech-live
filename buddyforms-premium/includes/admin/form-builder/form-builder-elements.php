...
JS;
		...
		case 'file':
			...
			$validation_multiple                            = isset( $customfield['validation_multiple'] ) ? $customfield['validation_multiple'] : false;
		...
		case 'form_actions':
			...
			$form_fields['general']['disabled_publish'] = new Element_Checkbox( '<b>' . __( 'Publish Button', 'buddyforms' ) . '</b>', "buddyforms_options[form_fields][" . $field_id . "][disabled_publish]", array( 'disabled_publish' => '<b>' . __( 'Check to disabled', 'buddyforms' ) . '</b>' ), array(
