...
if (count($config_files) === 0) {
  ...
  foreach ($config_files as $file) {
    ...
    echo ' &nbsp; <a class="confirmation-file post" href="options-general.php?page=advanced-iframe.php&remove-custom-header-id='.$rid.'">';
