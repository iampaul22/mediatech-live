		...
		<ul class="subnav">
			...
			<?php if ( bp_zoom_groups_can_user_manage_zoom( bp_loggedin_user_id(), bp_get_current_group_id() ) ) { ?>
				<li id="sync-meetings-groups-li" class="bp-groups-tab sync-meetings">
					<a href="#" id="meetings-sync" data-group-id="<?php echo esc_attr( bp_get_current_group_id() ); ?>" data-bp-tooltip="<?php esc_attr_e( 'Sync group meetings with Zoom', 'buddyboss-pro' ); ?>" data-bp-tooltip-pos="left">
