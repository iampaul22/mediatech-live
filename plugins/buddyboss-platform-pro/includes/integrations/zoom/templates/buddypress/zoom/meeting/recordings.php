...
if ( ! empty( $m_id ) && empty( $occurrence_id ) ) {
	...
	$occurrence_obj = BP_Zoom_Meeting::get_meeting_by_meeting_id( $occurrence_id );
						...
						<div class="recording-preview-img">
							...
							<div class="video_link">
								<?php if ( ! in_array( $recording_file->file_type, array( 'TIMELINE', 'TRANSCRIPT', 'CHAT', 'CC' ), true ) ) : ?>
									<a class="play_btn" href="<?php echo esc_url( $recording_file->play_url ); ?>"><?php esc_html_e( 'Play', 'buddyboss-pro' ); ?></a>
								<?php endif; ?>
							</div>
						</div>
							...
							<?php if ( bp_zoom_is_zoom_recordings_links_enabled() ) : ?>
								<div class="recording-button-wrap">
									...
									<?php if ( ! empty( $recording_file->download_url ) ) : ?>
										<a href="<?php echo esc_url( bp_zoom_get_recording_rewrite_url( $recording_file->download_url, $recording->id, true ) ); ?>" class="button small outline downloadmeeting downloadclip"><i class="bb-icon-download"></i><?php esc_html_e( 'Download', 'buddyboss-pro' ); ?></a>
									<?php endif; ?>
								</div>
							<?php endif; ?>
						</div>
