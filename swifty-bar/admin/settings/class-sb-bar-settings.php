...
class sb_bar_Settings extends sb_bar_Admin {
	...
	public function post_type() {
		...
		foreach ( $post_types as $post_type ) {
			if($post_type != 'page' && $post_type != 'attachment') {
				...
				<p>
					<input type="checkbox" id="<?php echo $this->sb_bar; ?>_options[post-type]" name="<?php echo $this->sb_bar; ?>_options[post-type][]" value="<?php echo sanitize_text_field( $post_type ); ?>" <?php echo $checked; ?> />
		   			<?php echo $post_type; ?>			
		   		</p>
			<?php }
	...
	public function ttr_input_field() {
		...
		?>
		<input type="text" id="<?php echo $this->sb_bar; ?>_options[ttr-text]" name="<?php echo $this->sb_bar; ?>_options[ttr-text]" value="<?php echo sanitize_text_field( $option ); ?>">
		<?php
	} // ttr_input_field()
	...
	public function author_input_field() {
		...
		?>
		<input type="text" id="<?php echo $this->sb_bar; ?>_options[by-text]" name="<?php echo $this->sb_bar; ?>_options[by-text]" value="<?php echo sanitize_text_field( $option ); ?>">
		<?php
	} // author_input_field()
	...
	public function wpm_field() {
		...
		?>
		<input type="text" id="<?php echo $this->sb_bar; ?>_options[wpm-text]" name="<?php echo $this->sb_bar; ?>_options[wpm-text]" value="<?php echo sanitize_text_field( $option ); ?>">
	...
	public function comment_box_id() {
		...
		?>
		<input type="text" id="<?php echo $this->sb_bar; ?>_options[comment-box-id]" name="<?php echo $this->sb_bar; ?>_options[comment-box-id]" value="<?php echo sanitize_text_field( $option ); ?>">
	...
	public function twitter_via() {
		...
		?>
		<input type="text" id="<?php echo $this->sb_bar; ?>_options[twitter-via]" name="<?php echo $this->sb_bar; ?>_options[twitter-via]" value="<?php echo sanitize_text_field( $option ); ?>">
	...
	public function custom_title() {
		...
		?>
		<input type="text" id="<?php echo $this->sb_bar; ?>_options[custom-title]" name="<?php echo $this->sb_bar; ?>_options[custom-title]" value="<?php echo sanitize_text_field( $option ); ?>">
